...
class ServiceNowConnector {
   ...
   */
    ...
    * @summary Checks if SNOW instance is hibernating or not
    ...
    * @summary Process the response of the SNOW API Call
    ...
    * @memberof ServiceNowConnector
    * @method sendRequest
    * @summary Sends SNOW request and verifies the response
